...
export default {
  ...
  'agent_config_saved': 'Đã lưu cấu hình SceneWeave Agent',
  'field_cleared': 'đã xóa',
  'api_key_mgmt': 'Quản lý khóa API',
  'api_key_usage_desc': 'Dùng để truy cập dự án SceneWeave từ các công cụ ngoài (ví dụ OpenClaw 🦞).',
  ...
  // config-status-store
  'agent_api_key_not_configured': 'Chưa cấu hình Khóa API SceneWeave Agent (Anthropic)',
  ...
  // SceneWeave Workbench v3 — Video Tham Chiếu
