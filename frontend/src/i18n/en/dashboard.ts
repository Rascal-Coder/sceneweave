...
export default {
  ...
  'sceneweave_agent': 'SceneWeave Agent',
  ...
  'agent_config_saved': 'SceneWeave Agent configuration saved',
  'field_cleared': 'cleared',
  'api_key_mgmt': 'API Key Management',
  'api_key_usage_desc': 'Used to access SceneWeave projects from external tools (e.g. OpenClaw 🦞).',
  ...
  // config-status-store
  'agent_api_key_not_configured': 'SceneWeave Agent API Key (Anthropic) not configured',
  ...
  // SceneWeave Workbench v3 — Reference Video
