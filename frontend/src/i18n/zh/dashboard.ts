...
export default {
  ...
  'sceneweave_agent': 'SceneWeave 智能体',
  ...
  'agent_config_saved': 'SceneWeave 智能体配置已保存',
  'field_cleared': '已清除',
  'api_key_mgmt': 'API 密钥管理',
  'api_key_usage_desc': '用于从外部工具（如 OpenClaw 🦞）访问 SceneWeave 项目。',
  ...
  // config-status-store
  'agent_api_key_not_configured': 'SceneWeave 智能体 API Key（Anthropic）未配置',
