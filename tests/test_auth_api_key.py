...
class TestVerifyAndGetPayloadAsync:
    ...
    async def test_jwt_path_not_called_for_api_key(self):
        ...
        with (
            ...
            await auth_module._verify_and_get_payload_async("scw-somekey")
